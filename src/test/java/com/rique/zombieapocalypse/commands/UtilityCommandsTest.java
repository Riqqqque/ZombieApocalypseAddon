...
class UtilityCommandsTest {
    ...
    void cleanupMessageExplainsUninstallPrep() {
        assertEquals(
                "Cleanup complete. Removed 0 zombie-class entities and reset apocalypse event state. Custom spawning, events, scaling, attributes, block breaking, block placing, towering, animal hunting, sunlight immunity, extra drops, and death cooldowns are disabled.",
